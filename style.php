...
/**
* Otimisation et mise en cache du style
*/
$global_style_file = $phpbb_root_path . 'style.css';
if(file_exists($global_style_file)) {  
  header ('HTTP/1.1 301 Moved Permanently');
  header ('Location: '.$global_style_file);  
  exit;
}
...
$output_style = compress(ob_get_contents());
$f = fopen($global_style_file, "w");
fwrite($f, $output_style);
fclose($f); 
