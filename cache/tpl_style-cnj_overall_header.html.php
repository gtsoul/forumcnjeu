...
<link rel="shortcut icon" href="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>images/favicon.ico" type="image/x-icon" />
<link rel="icon" href="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>images/favicon.ico" type="image/x-icon" />
...
<body id="phpbb" class="section-<?php echo (isset($this->_rootref['SCRIPT_NAME'])) ? $this->_rootref['SCRIPT_NAME'] : ''; ?> <?php echo (isset($this->_rootref['S_CONTENT_DIRECTION'])) ? $this->_rootref['S_CONTENT_DIRECTION'] : ''; ?>">
  ...
  <div class="header">
    <div class="container-header-menu">
      ...
      <div class="container">    					
        <!-- header-menu -->
        <nav role="navigation" id="header-menu">										  			           		
          <ul class="menu">        
          
            <li class="item-101">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/">CNJ</a>
            </li>
            <!--li class="item-102">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/presentation/qui-sommes-nous/presentation">Qui sommes-nous ?</a>
            </li>
            <li class="item-107">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/agenda/agenda">Agenda</a>
            </li>
            <li class="item-108">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/actualites/actualites">Actualités</a>
            </li-->
            <li class="item-173 current active">
              <a href="<?php echo (isset($this->_rootref['CNJEU_FORUM_URL'])) ? $this->_rootref['CNJEU_FORUM_URL'] : ''; ?>">Forum</a>
            </li>
            <!--li class="item-176">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/informations-pratiques/adherer-soutenir/informations-pratiques">Informations pratiques</a>
            </li>
            <li class="item-177">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/contacts">Contacts</a>
            </li>
            <li class="item-178">
              <a href="<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/presse-pro/presse-pro/presse-pro">Presse/Pro</a>
            </li-->
            <!--li>
            ...
            <?php if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?>            
              ...
              <?php } if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>
                ...
                <li>
                  <a href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?>" accesskey="e">Mon compte</a>
              ...
              <?php } if ($this->_rootref['S_DISPLAY_SEARCH'] && ! $this->_rootref['S_IN_SEARCH']) {  ?>
                ...
                <li id="search-box" class="rightside">
...
<div id="wrap">
  ...
  <style>
    ...
    #wrap {
      background: url("styles/style_cnj/theme/images/bg_wrap.png") repeat scroll left top transparent;
    }  
    #logo_div {
      background: url("styles/style_cnj/theme/images/logo_cnj_footer.png") no-repeat scroll left top transparent;
      width: 367px;
      height: 76px;
      position: absolute;
      top: 0;
    ...
    .header .container-header-menu {
      background: url("<?php echo (isset($this->_rootref['CNJEU_URL'])) ? $this->_rootref['CNJEU_URL'] : ''; ?>/templates/lch_cnj/images/fond-header.png") repeat-x scroll left top transparent;
      height: 46px;
	  margin-bottom: -5px;
    }
    .container {
    ...
    .header #header-menu ul.menu li, .header #header-menu ul.menu li a {
      color: #898989;
      font-size: 13px;
      text-decoration: none;
    }
    .header #header-menu ul.menu li input {
      font-size: 10px;
    }
    .header #header-menu ul.menu li a:hover, .header #header-menu ul.menu li.current a, .header #header-menu ul.menu li.active a {
      color: #FFFFFF;
    }
  </style>
