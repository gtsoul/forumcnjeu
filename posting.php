...
// BEGIN Allowed Attachment Extensions Mod
if ($allowed)
{
	if (!function_exists('allowed_extensions'))
	{
		include($phpbb_root_path . 'includes/functions_extensions.' . $phpEx);
	}	
	allowed_extensions($forum_id);
}
// END Allowed Attachment Extensions Mod
// Attachment entry
